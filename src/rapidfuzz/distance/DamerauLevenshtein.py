...
distance = _fallback_import(
    _mod, "damerau_levenshtein_distance", cached_scorer_call=_dist_attr
)
similarity = _fallback_import(
    _mod, "damerau_levenshtein_similarity", cached_scorer_call=_sim_attr
)
normalized_distance = _fallback_import(
    _mod, "damerau_levenshtein_normalized_distance", cached_scorer_call=_norm_dist_attr
)
normalized_similarity = _fallback_import(
    _mod, "damerau_levenshtein_normalized_similarity", cached_scorer_call=_norm_sim_attr
)
