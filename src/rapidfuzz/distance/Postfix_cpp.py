...
if supports(AVX2):
    from rapidfuzz.distance.metrics_cpp_avx2 import postfix_distance as distance
    ...
    from rapidfuzz.distance.metrics_cpp_avx2 import postfix_similarity as similarity
else:
