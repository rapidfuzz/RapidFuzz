...
if supports(AVX2):
    from rapidfuzz.distance.metrics_cpp_avx2 import indel_distance as distance
    ...
    from rapidfuzz.distance.metrics_cpp_avx2 import indel_similarity as similarity
