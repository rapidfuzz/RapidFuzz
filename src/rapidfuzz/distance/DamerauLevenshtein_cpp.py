...
if supports(AVX2):
    from rapidfuzz.distance.metrics_cpp_avx2 import damerau_levenshtein_distance as distance
    ...
    from rapidfuzz.distance.metrics_cpp_avx2 import damerau_levenshtein_similarity as similarity
else:
