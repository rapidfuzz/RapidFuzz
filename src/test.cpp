...
static PyObject *__pyx_f_4test_test(void) {
      ...
      /*try:*/ {
        {
            ...
            __pyx_parallel_why = 0;
                ...
                #define unlikely(x) (x)
            #endif
            __pyx_t_2 = (10 - 0 + 1 - 1/abs(1)) / 1;
            if (__pyx_t_2 > 0)
            {
                #ifdef _OPENMP
                #pragma omp parallel private(__pyx_t_3) private(__pyx_filename, __pyx_lineno, __pyx_clineno) shared(__pyx_parallel_why, __pyx_parallel_exc_type, __pyx_parallel_exc_value, __pyx_parallel_exc_tb)
                #endif /* _OPENMP */
                {
                    #ifdef _OPENMP
                    #ifdef WITH_THREAD
                    ...
                    #endif /* _OPENMP */
                    #ifdef _OPENMP
                    #pragma omp for firstprivate(__pyx_v_i) lastprivate(__pyx_v_i) lastprivate(__pyx_v_var)
                    #endif /* _OPENMP */
                    ...
                    #else
{
            ...
            if (__pyx_parallel_why) {
              ...
              __pyx_v_var = __pyx_parallel_temp1;
